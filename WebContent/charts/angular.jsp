...
String xml = "<Chart bgColor='FFFFFF' upperLimit='100' lowerLimit='0' showLimits='1' baseFontColor='666666' majorTMNumber='11' majorTMColor='666666' majorTMHeight='8' minorTMNumber='5' minorTMColor='666666' minorTMHeight='3' pivotRadius='20' showGaugeBorder='0' gaugeOuterRadius='100' gaugeInnerRadius='90' gaugeOriginX='170' gaugeOriginY='170' gaugeScaleAngle='320' displayValueDistance='10' placeValuesInside='1' gaugeFillMix='' pivotFillMix='{F0EFEA}, {BEBCB0}' pivotBorderColor='BEBCB0' pivotfillRatio='80,20' showShadow='0' dataStreamURL='"+request.getContextPath()+"/chart/chart.do?method=getChart' refreshInterval='1'>"+
	"<colorRange>"+
...
<body>
	...
	<script type="text/javascript">
	  var  xml = "<%=xml%>";
	  var  myChart = new FusionCharts("${ctx}/commons/charts/AngularGauge.swf","viewAllChartId", "340", "330", "0", "1");
